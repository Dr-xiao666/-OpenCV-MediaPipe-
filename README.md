...
这是一个**基于 Pygame、Mediapipe 和 OpenCV**实现的**PC 端体感游戏**。玩家通过**手势控制**切割屏幕上的水果获取分数。在传统切水果玩法的基础上，创新地引入了**表情识别（笑脸/哭脸）**切换游戏模式、**Boss 战（奶龙）**以及**排行榜系统**，使交互更加有趣和好玩。
...
| 成员 | GitHub | 主要分工 |
| --- | --- | --- |
| 待补充 | [@Dr-xiao666](https://github.com/Dr-xiao666) | 待补充（例如：手势识别与切割判定、游戏主循环、Boss 战） |
| 待补充 | [@同学的GitHub用户名](https://github.com/同学的GitHub用户名) | 待补充（例如：表情识别切模式、排行榜系统、UI 与美术素材） |
